...
<div class="h-128"> 
    <footer class="h-auto my-5 bottom-0">
        <div class="bg-cover bg-center h-full"
            ...
            <div class="grid grid-cols-2 gap-4 text-white text-sm pb-4">
                ...
                <div class="flex-1 flex-wrap justify-self-center gap-4 italic relative">
                    <div>
                        <img class="max-h-28 mx-auto" src="{{asset('images/cropped-logo_fgm-2-1.webp')}}" 
                            alt="Logo Fundacji">
                    </div>
        ...
        $href = array(
            array("https://www.facebook.com/Fundacja.Glos.Mlodych", "images/Facebook.png", "Nasz profil na facebook"),
            array("https://twitter.com/Portal_e_magnes", "images/Twitter.png", "Twitter"),
            array("mailto:$email", "images/Mail.png", "Napisz do nas"),
            array("/o-fundacji", "images/AboutMe.png", "AboutMe"),
             ); ?>
